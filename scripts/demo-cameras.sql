...
SELECT 'Illustrative record A', 'Fixed dome', 41.9004, 12.4936, 'demo', 'Development seed', 'Demo data',
...
INSERT INTO cameras (title, kind, latitude, longitude, status, source, updated, description, created_at)
SELECT 'Illustrative record B', 'Traffic monitoring', 41.9047, 12.5031, 'demo', 'Development seed', 'Demo data',
