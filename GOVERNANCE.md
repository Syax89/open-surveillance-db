...
Initial maintainers and the moderation contact are now named above (2026-07-31). Still open before launch: conflict-of-interest rules, an appeal process, a monitored private disclosure address with a response-time commitment (see [SECURITY.md](SECURITY.md)), and publication of governance and reporting contacts on a public surface. This document is a starting proposal, not a claim that those structures already exist.
