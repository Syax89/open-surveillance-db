    ...
    <section className="tool-section report-tool" aria-labelledby="report-tool-title">
      ...
      <WriteGateWall returnTo={returnTo}>
        <ReportForm
          ...
          geolocationAvailable={report.geolocationAvailable}
          geolocating={report.geolocating}
          geolocationNotice={report.geolocationNotice}
          requestMyPosition={report.requestMyPosition}
