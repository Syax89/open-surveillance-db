...
export default function Home() {
  ...
  return <main id="main-content">
    ...
    <footer id="about"><div className="brand"><span className="brand-mark" aria-hidden="true">◉</span><span>OpenSurveillanceDB</span></div><p>{t.footerLineOne}<br />{t.footerLineTwo}</p><div className="footer-links"><a href="/guide">{t.howItWorks}</a><a href="/api/cameras?format=geojson">{t.openData}</a><a href="#report">{t.contribute}</a><a href="/privacy">{common.privacy}</a><a href="/termini">{common.terms}</a><a href="/licenze">{common.licences}</a><a href="#top">{t.backToTop} ↑</a></div></footer>
  </main>;
}
