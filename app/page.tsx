...
export default function Home() {
  ...
  return <main id="main-content">
    <nav className="nav-shell" aria-label={t.mainNavigation}>
      ...
      <div className={`nav-links ${menuOpen ? "is-open" : ""}`} id="main-links"><a href="#map">{t.exploreMap}</a><a href="#records">{t.browseRecords}</a><a href="/guide">{t.howItWorks}</a><a href="/regole">{t.rules}</a><a className="nav-action" href="#report">{t.addCamera}</a></div><LocaleToggle />
    </nav>
