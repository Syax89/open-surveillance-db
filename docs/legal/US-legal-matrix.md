...
| New York | Thruway gantries (70) | **Terms OPEN-NY verificati direttamente (PDF 2013-03-08): "least restrictive, no attribution, no share-alike, no pre-approval, use as you wish"** | ✅ **PUBBLICABILE** |
| Sweden | Trafikverket API Camera (~1.000) | **Licenza API: CC0 1.0** (link ufficiale "Licens - senaste versionen" → creativecommons.org/publicdomain/zero/1.0) | ✅ **PUBBLICABILE** |
| Texas | TxDOT CCTV (2.798) | licenseInfo: "provided for **informational purposes only**" | ⛔ NO (uso informativo, non riuso) |
