...
- **Reviewer:** a trained moderator (../MODERATION.md) — the legal-emergency power is reserved to the administrator (ADR 0021 § 8).
...
1. Report received via the privacy/safety channel (`privacy@opensurveillancedb.org` — dedicated, monitored mailbox) or the private correction form.
...
- decision (hidden-admin-legal / removed-admin-legal);
