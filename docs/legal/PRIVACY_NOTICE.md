...
| Moderator identity (email, display name, full name via ChatGPT sign-in) | OpenAI (identity provider) | Authenticate moderators for the residual human step: legal-emergency admin actions (../MODERATION.md) | art. 6(1)(f); **never logged or stored by the application** |
