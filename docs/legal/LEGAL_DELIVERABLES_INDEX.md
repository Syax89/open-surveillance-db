...
|----------|-------------------|--------|-------|
| [RETENTION_SCHEDULE.md](RETENTION_SCHEDULE.md) | P1, M3 — retention values (community model: no time-based record retention for `active`/`hidden`/`removed`; 2-year audit; evidence, backups, operational logs; R14 community actions; R13 photo lifecycle **retired 2026-08-08 — retained objects, no deletion**), legal hold, deletion definition | Draft | Rosa |
...
| [PROCESSOR_REGISTER.md](PROCESSOR_REGISTER.md) | P5, M4 — Cloudflare (DPA v6.3 + SCC + EU residency + EU–US DPF; **Workers + D1 + Email Routing**; R2 photo storage **retired 2026-08-08**), GitHub/Google OIDC (PR5/PR6 — not a processor while dormant; no email imported), others | Draft | Rosa |
...
| [decisions/0005-processors-and-data-residency.md](../decisions/0005-processors-and-data-residency.md) | ADR — processor choice, SCC, EU residency, GitHub/Google OIDC role | Proposed | Rosa |
...
| [REVIEW_R2_REGISTER_PRIVACY_2026-08-01.md](REVIEW_R2_REGISTER_PRIVACY_2026-08-01.md) | GAP 3 — R2 photo storage active (PR #64): PROCESSOR_REGISTER PR1/TIA/backup row + PRIVACY_NOTICE § 5/§ 6 aligned; R2 bucket region/jurisdiction open item (CTO/ada). **Historical — photo upload removed 2026-08-08; R2 open item closed (PRIVACY_NOTICE v0.12)** | Delivered (PR) | Rosa |
