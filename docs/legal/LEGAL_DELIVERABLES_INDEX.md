...
| [PROCESSOR_REGISTER.md](PROCESSOR_REGISTER.md) | P5, M4 — Cloudflare (DPA v6.3 + SCC + EU residency + EU–US DPF; **Workers + D1 + Email Routing**; R2 photo storage **retired 2026-08-08**), OpenAI auth (not a processor; never log emails), others | Draft | Rosa |
