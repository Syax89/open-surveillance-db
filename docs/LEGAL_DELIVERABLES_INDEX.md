...
These files are committed to the repository under `docs/` (policy documents) and `docs/decisions/` (ADRs 0002/0003) on branch `docs/pre-launch-legal-deliverables`, with cross-links added in `docs/PRIVACY_AND_SAFETY.md` ("User rights and accountability"), `docs/MODERATION.md` ("Appeals and corrections"), and `SECURITY.md` ("Incident response"). All documents remain **drafts pending human review** — nothing here is a published commitment.
