...
New reports enter the database as `pending`. Public API responses and GeoJSON exports return only `verified` records, plus fictional `demo` records in the local prototype. Evidence and reviewer notes are never part of the public API.
