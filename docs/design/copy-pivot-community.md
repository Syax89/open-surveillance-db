...
| Foto segnalazione (`report.ts` photoAdded/photoHelp, legali) | Le foto **restano** individualmente moderate con redazione confermata prima della pubblicazione (`app/api/cameras/route.ts` commenti; legale §5/§7). Vero post-pivot. |
